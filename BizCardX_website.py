...
st.caption("by [Elamparithi](https://www.linkedin.com/in/elamparithi-t/)")

# sidebar MENU
selected = option_menu(None, ["Home", "Modify", 'About'],
                       icons=["house", "pencil-square", "info"],
                       default_index=0)


mydb = sql.connect(host="192.168.0.114", user="root",
                   password="1king#lanka", database="your database")
